...
<div class="contain">
    ...
    <script>
        ...
        window.onload = function () {
            ...
            var garden_id = currentURL.searchParams.get("garden_id");

            var currentDate = new Date();
            var day = currentDate.getDate();
            var month = currentDate.getMonth() + 1; 
            var year = currentDate.getFullYear();
            var url = 'https://digitaldetectives.top/Graph/Battery/Battery_day.php?user=' + user + '&garden_id=' + garden_id + '&date=' + year.toString() +'-'+month.toString()+'-'+day.toString();
            $.ajax({
                url: url,
                type: 'GET',
                success: function(response) {
                    ...
                    chartTemp.render();
                    if(jsonObject.node != 0){
                        document.getElementById('temperature').innerHTML = parseFloat(jsonObject.node.toFixed(1)) + '%';
            ...
            document.getElementById('node_name').innerHTML = 'garden ' + garden_id;
            ...
            document.getElementById('month_render').addEventListener('click', function (){
                document.getElementById('date').innerHTML = 'Month: ' + selectedMonth.toString() + '/' + selectedYear.toString();
                var url = 'https://digitaldetectives.top/Graph/Battery/Battery_month.php?user=' + user + '&garden_id=' + garden_id + '&month=' + selectedYear.toString() +'-'+selectedMonth.toString();
                console.log(url);
                $.ajax({
                      url: url,
                      type: 'GET',
