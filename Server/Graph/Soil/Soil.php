...
<div class="contain">
    ...
    <script>
        ...
        window.onload = function () {
            ...
            var url = 'https://digitaldetectives.top/Graph/Soil/Soil_day.php?user=' + user + '&garden_id=' + garden_id + '&date=' + year.toString() +'-'+month.toString()+'-'+day.toString();
            $.ajax({
                url: url,
                type: 'GET',
            ...
            document.getElementById('month_render').addEventListener('click', function (){
                ...
                var url = 'https://digitaldetectives.top/Graph/Soil/Soil_month.php?user=' + user + '&garden_id=' + garden_id + '&month=' + selectedYear.toString() +'-'+selectedMonth.toString();
                console.log(url);
                $.ajax({
                      url: url,
                      type: 'GET',
