...
<div class="contain">
    ...
    <script>
        ...
        window.onload = function () {
            ...
            var url = 'http://localhost/.iot/soil/graph.php?user=' + user + '&node_id=' + node_id + '&date=' + year.toString() +'-'+month.toString()+'-'+day.toString();
            //var url = 'https://digitaldectectives.azdigi.blog/graph/soil/graph.php?user=' + user + '&node_id=' + node_id + '&date=' + year.toString() +'-'+month.toString()+'-'+day.toString();
            $.ajax({
                url: url,
                type: 'GET',
                success: function(response) {
                    ...
                    chartTemp.render();
                    if(jsonObject.node_soil != 0){
                        document.getElementById('temperature').innerHTML = parseFloat(jsonObject.node_soil.toFixed(1)) + '%';
            ...
            document.getElementById('month_render').addEventListener('click', function (){
                var url = 'http://localhost/.iot/soil/graph_m.php?user=' + user + '&node_id=' + node_id + '&month=' + selectedYear.toString() +'-'+selectedMonth.toString();
                //var url = 'https://digitaldectectives.azdigi.blog/graph/soil/graph_m.php?user=' + user + '&node_id=' + node_id + '&month=' + selectedYear.toString() +'-'+selectedMonth.toString();
                console.log(url);
                $.ajax({
                      url: url,
                      type: 'GET',
